...
<div class="row">
  <div class="col-md-6 mx-auto">
    <p class="text-center"><strong>Total: <?php echo e(Gloudemans\Shoppingcart\Facades\Cart::subtotal()); ?> €</strong></p>
    <hr>
    <div class="row primary" style="background-color:#0d6efd">
        <div class="col-md-12">
            <form action="<?php echo e(route('checkout.store')); ?>" method="POST" class="row mt-2">
                <?php echo csrf_field(); ?>

                <div class="col-md-4">
                    <label for="total" class="form-label">Total</label>
                    <input type="text" class="form-control" id="total" name="total" value="<?php echo e(Gloudemans\Shoppingcart\Facades\Cart::subtotal()); ?>" readonly>
                </div>
                <div class="col-md-4">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mobi_web_shop\resources\views/checkout.blade.php ENDPATH**/ ?>